...
import codestudioapps.tiktokvideo.testtiktokvideodownloader.MainActivity;
...
public class ClipboardMonitor extends Service {
    ...
    private void startInForeground() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this,getPackageName()+"-"+getString(R.string.app_name))
                ...
                .setTicker("TICKER")
                .addAction(R.drawable.navigation_empty_icon,  "Stop", makePendingIntent(Constants.STOPFOREGROUND_ACTION))
