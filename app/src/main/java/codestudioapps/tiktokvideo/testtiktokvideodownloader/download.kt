package codestudioapps.tiktokvideo.testtiktokvideodownloader
...
import codestudioapps.tiktokvideo.testtiktokvideodownloader.receiver.Receiver
import codestudioapps.tiktokvideo.testtiktokvideodownloader.services.ClipboardMonitor
import codestudioapps.tiktokvideo.testtiktokvideodownloader.tasks.downloadVideo
import codestudioapps.tiktokvideo.testtiktokvideodownloader.utils.Constants.STARTFOREGROUND_ACTION
import codestudioapps.tiktokvideo.testtiktokvideodownloader.utils.Constants.STOPFOREGROUND_ACTION
import codestudioapps.tiktokvideo.testtiktokvideodownloader.utils.iUtils;
import codestudioapps.tiktokvideo.testtiktokvideodownloader.utils.iUtils.isPackageInstalled
...
class download : Fragment() {
   ...
   lateinit var prefEditor: SharedPreferences.Editor;
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        createNotificationChannel(requireActivity(), NotificationManagerCompat.IMPORTANCE_LOW,true,getString(
            R.string.app_name
    ...
    fun createNotificationChannel(context: Context, importance: Int, showBadge: Boolean, name: String, description: String) {
     ...
     private   fun  setNofication(b: Boolean) {
                ...
                if(b){
                    val channelId = "${context!!.packageName}-${context!!.getString(
                        R.string.app_name
                    )}"
